<template>
  <div class="game-container">
    ...
    <div class="transaction-form">
      <h3 class="form-label">Ingrese monto a pagar:</h3>
      ...
      <div class="destination-section">
        <h3 class="form-label">Destino <i class="bi bi-arrow-down"></i>:</h3>
        <div class="dropdown">
          <button 
          ...
          <ul class="dropdown-menu w-100">
            <li v-for="player in otherPlayers" :key="player.id">
              <a 
                class="dropdown-item" 
                href="#" 
                @click.prevent="selectDestination(player.name)"
              >
                {{ player.name }}
              </a>
            </li>
            <li><a class="dropdown-item" href="#" @click.prevent="selectDestination('Banco')">Banco</a></li>
          </ul>
        </div>
      </div>

      <button 
        class="btn btn-danger send-money-btn" 
